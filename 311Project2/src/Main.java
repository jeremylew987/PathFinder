...
public class Main {
	...
	public static void main(String[] args) throws Exception{
		...
		// Read the file
		pF.readInput("sample3.txt");
		System.out.println();
		System.out.println("Shortest path distances to all vertices\n");
		System.out.println("Cost of Reachability Tree " + 
				pF.minCostOfReachabilityFromSrc(0) + "\n");
				System.out.println();
				int[] tree = pF.minCostReachabilityFromSrc(0);
				System.out.println("Minimum Cost Reachability of 0");
				for (int i=0; i<tree.length; i++)
				if (tree[i] != -1 && i != tree[i])
				System.out.println("edge between " + i + " and " + 
				tree[i]);
				System.out.println();
				
				
				tree = pF.minCostReachabilityFromSrc(7);
				System.out.println("Minimum Cost Reachability of 7");
				for (int i=0; i<tree.length; i++)
				if (i != tree[i])
				System.out.println("edge between " + i + " and " + 
				tree[i]);
				
				pF.readInput("sample.txt");
		double[] sDistances = pF.shortestPathDistances(1);
		ArrayList<Integer> p1 = pF.fromSrcToDest(1, 17, 0, 1);
		...
		System.out.println("Distance from 3 to " + i + ": " + 
		sDistances[i]);
		System.out.println();
		System.out.println();
		...
		System.out.println();
		System.out.println();
		 tree = pF.minCostReachabilityFromSrc(0);
		System.out.println("Minimum Cost Reachability of 0");
		for (int i=0; i<tree.length; i++)
		if (i != tree[i])
		System.out.println("edge between " + i + " and " + 
		...
		System.out.println();
		System.out.println("Cost of Reachability Tree " + 
		pF.minCostOfReachabilityFromSrc(3) + "\n");
		System.out.println();
